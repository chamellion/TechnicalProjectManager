    ...
    def respond(self, input_text):
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                {"role" : "system", "content": f"{self.persona} Forget every previous context."},
    ...
    def respond(self, input_text):
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "system", "content": f"You are {self.persona}, a knowledge-based assistant."
                                              f" Forget previous context. Use only the following knowledge to answer, "
                                              f"do not use your own knowledge: {self.knowledge}. Answer based on this knowledge, not your own."},
...
class RoutingAgent():
    ...
    def route_prompt_to_agent(self, user_input):
...
class ActionPlanningAgent:
    ...
    def extract_steps_from_prompt(self, prompt):
        ...
        system_prompt = (f"You are an action planning agent. Using your knowledge, "
                         f"you extract from the user prompt the steps requested to complete the action the user is asking for "
                         f"You return the steps as a list. Only return the steps in your knowledge. Forget any previous context. "
